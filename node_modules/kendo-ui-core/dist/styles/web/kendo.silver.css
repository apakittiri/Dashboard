...
.k-primary.k-state-disabled:active {
  ...
  background-image: url('textures/highlight.png');
  background-image: none, -webkit-linear-gradient(top, #88bbdd 0%, #6eadd6 100%);
  background-image: none, -moz-linear-gradient(top, #88bbdd 0%, #6eadd6 100%);
  background-image: none, -o-linear-gradient(top, #88bbdd 0%, #6eadd6 100%);
  background-image: none, linear-gradient(to bottom, #88bbdd 0%, #6eadd6 100%);
  -webkit-box-shadow: none;
  box-shadow: none;
}
