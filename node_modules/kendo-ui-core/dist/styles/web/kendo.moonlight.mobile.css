...
.km-scroller-refresh .km-loading-right {
  ...
  -moz-animation: km-webload 0.6s infinite linear;
...
.km-scroller-refresh .km-loading-right {
  ...
  -moz-animation: km-webrefresh 0.6s infinite linear;
...
.km-state-active .km-detail {
  -webkit-box-shadow: inset 0 0 0 1000px rgba(33, 42, 51, 0.2);
  box-shadow: inset 0 0 0 1000px rgba(33, 42, 51, 0.2);
}
/* Switch */
.km-switch-wrapper {
...
.km-switch-background {
  ...
  background-image: url("textures/brushed-metal.png"), -moz-linear-gradient(top, #bababa, #bababa);
  background-image: url("textures/brushed-metal.png"), -o-linear-gradient(top, #bababa, #bababa);
...
.km-list > li {
  background: #171d24;
  border-color: rgba(255, 255, 255, 0.2);
  -webkit-box-shadow: inset 0 1px 0 rgba(33, 42, 51, 0.2);
  box-shadow: inset 0 1px 0 rgba(33, 42, 51, 0.2);
}
.km-listinset > li:first-child,
.km-listgroupinset .km-list > li:first-child {
  border-color: rgba(255, 255, 255, 0.2);
...
.km-widget.km-actionsheet > li > a {
  background: #e6ebf1;
  border-bottom-color: rgba(33, 42, 51, 0.2);
}
...
.km-popup .k-list-container {
  background: rgba(0, 0, 0, 0.4);
  border-top-color: rgba(33, 42, 51, 0.2);
}
/* PopOver */
.km-popup.km-pane {
