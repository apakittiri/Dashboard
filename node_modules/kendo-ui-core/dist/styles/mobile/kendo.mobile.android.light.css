...
.km-android .km-rowdelete {
  background-image: -webkit-gradient(linear, 50% 0, 50% 100%, color-stop(0,rgba(68,68,68,0.5)), color-stop(0.5,rgba(204,204,204,0.5)), color-stop(0.5,rgba(68,68,68,0.1)), color-stop(1,rgba(68,68,68,0)));
  background-image: -blink-linear-gradient(top,rgba(68,68,68,0.5),rgba(204,204,204,0.5) 50%,rgba(68,68,68,0.1) 50%,rgba(68,68,68,0));
  background-image: -moz-linear-gradient(top,rgba(68,68,68,0.5),rgba(204,204,204,0.5) 50%,rgba(68,68,68,0.1) 50%,rgba(68,68,68,0));
  background-image: -ms-linear-gradient(top,rgba(68,68,68,0.5),rgba(204,204,204,0.5) 50%,rgba(68,68,68,0.1) 50%,rgba(68,68,68,0));
  background-image: -o-linear-gradient(top,rgba(68,68,68,0.5),rgba(204,204,204,0.5) 50%,rgba(68,68,68,0.1) 50%,rgba(68,68,68,0));
  border-color: #444444;
