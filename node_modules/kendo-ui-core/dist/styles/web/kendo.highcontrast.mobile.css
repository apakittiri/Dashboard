...
.km-switch-background {
  ...
  background-image: url(textures/glass-lighter.png), -moz-linear-gradient(top, #bababa, #bababa);
  background-image: url(textures/glass-lighter.png), -o-linear-gradient(top, #bababa, #bababa);
