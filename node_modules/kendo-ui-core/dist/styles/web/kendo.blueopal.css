...
.k-event {
  border-color: #92daf7;
  background: #92daf7 0 -257px url('textures/highlight.png') repeat-x;
  color: #003f59;
}
.k-event-inverse {
  color: #ffffff;
...
.k-draghandle.k-state-selected:hover {
  ...
  background-image: none, -moz-linear-gradient(top, rgba(255,255,255,.0) 0%, rgba(255,255,255,.23) 100%);
  background-image: none, -o-linear-gradient(top, rgba(255,255,255,.0) 0%, rgba(255,255,255,.23) 100%);
...
.k-tooltip-validation .k-callout-n {
  border-bottom-color: #ffebaf;
}
.k-tooltip-validation .k-callout-w {
  border-right-color: #ffebaf;
}
.k-tooltip-validation .k-callout-s {
  border-top-color: #ffebaf;
}
.k-tooltip-validation .k-callout-e {
  border-left-color: #ffebaf;
}
/* Splitter */
.k-splitbar {
  background-color: #daecf4;
...
.k-state-selected {
  -webkit-box-shadow: inset 0 0 7px rgba(0, 92, 131, 0.5);
  box-shadow: inset 0 0 7px rgba(0, 92, 131, 0.5);
}
.k-state-active {
  -webkit-box-shadow: none;
  box-shadow: none;
...
.km-pane-wrapper .k-mobile-list .k-item.k-state-selected {
  background-color: #13688c;
  border-top-color: #13688c;
}
.km-pane-wrapper .k-mobile-list .k-recur-view > .k-edit-field .k-check:first-child {
  border-top-color: transparent;
}
.km-pane-wrapper .k-mobile-list .k-item:last-child {
  -webkit-box-shadow: inset 0 -1px 0 #94c0d2;
  box-shadow: inset 0 -1px 0 #94c0d2;
}
...
.km-pane-wrapper .k-mobile-list .k-edit-field {
  -webkit-box-shadow: 0 1px 1px #94c0d2;
  box-shadow: 0 1px 1px #94c0d2;
}
...
.k-grid td.k-state-focused {
  -webkit-box-shadow: inset 0 0 0 1px inset 0 0 3px 1px #7ec6e3;
  box-shadow: inset 0 0 0 1px inset 0 0 3px 1px #7ec6e3;
}
.k-header,
.k-grid-header-wrap,
...
.k-primary {
  ...
  border-color: #7ec6e3;
  background-image: url('textures/highlight.png');
  background-image: none, -webkit-linear-gradient(top, #afe4fa 0%, #7ed3f6 100%);
  background-image: none, -moz-linear-gradient(top, #afe4fa 0%, #7ed3f6 100%);
  background-image: none, -o-linear-gradient(top, #afe4fa 0%, #7ed3f6 100%);
  background-image: none, linear-gradient(to bottom, #afe4fa 0%, #7ed3f6 100%);
  background-position: 50% 50%;
  background-color: #7bd2f6;
  -webkit-box-shadow: none;
  box-shadow: none;
...
.k-primary:hover {
  ...
  border-color: #7ec6e3;
  background-image: url('textures/highlight.png');
  background-image: none, -webkit-linear-gradient(top, #8acde9 0%, #42aedb 100%);
  background-image: none, -moz-linear-gradient(top, #8acde9 0%, #42aedb 100%);
  background-image: none, -o-linear-gradient(top, #8acde9 0%, #42aedb 100%);
  background-image: none, linear-gradient(to bottom, #8acde9 0%, #42aedb 100%);
...
.k-primary:active {
  ...
  border-color: #13688c;
  background-image: url('textures/highlight.png');
  background-image: none, -webkit-linear-gradient(top, #0e6589 0%, #2c7899 100%);
  background-image: none, -moz-linear-gradient(top, #0e6589 0%, #2c7899 100%);
  background-image: none, -o-linear-gradient(top, #0e6589 0%, #2c7899 100%);
  background-image: none, linear-gradient(to bottom, #0e6589 0%, #2c7899 100%);
  background-color: #13688c;
  -webkit-box-shadow: none;
  box-shadow: none;
}
