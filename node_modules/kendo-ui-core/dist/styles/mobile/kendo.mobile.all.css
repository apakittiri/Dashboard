...
.km-widget .k-dropdown-wrap {
  display: inline-block;
}
.km-widget .km-listview-label:after,
.km-widget input ~ .km-listview-link:after,
.km-widget textarea ~ .km-listview-link:after,
.km-widget select ~ .km-listview-link:after,
.km-widget .k-dropdown ~ .km-listview-link:after {
  display: none;
}
...
.km-ios .km-actionsheet > li > a {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.5),rgba(255,255,255,0.45) 6%,rgba(255,255,255,0.2) 50%,rgba(255,255,255,0.15) 50%,rgba(100,100,100,0));
...
.km-ios .km-button {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.35),rgba(255,255,255,0.1) 50%,rgba(255,255,255,0) 50%,rgba(255,255,255,0));
...
.km-ios .k-slider-selection {
  ...
  background-image: -blink-linear-gradient(top,#dbdbdb,#eeeeee 50%);
...
.km-ios .km-switch-background:after {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.14) 0,rgba(255,255,255,0.4));
...
.km-ios .km-switch-container {
  ...
  background-image: -blink-linear-gradient(top,rgba(0,0,0,0),rgba(0,0,0,0) 95%,rgba(0,0,0,0.2));
...
.km-ios .km-checkbox-checked {
  ...
  background-image: -blink-linear-gradient(top,#f1969b,rgba(230,70,78,0.5) 50%,rgba(222,11,21,0.5) 50%,rgba(183,0,0,0));
...
.km-ios .km-switch-handle {
  ...
  background-image: -blink-linear-gradient(top,#ffffff,#d7d7d7 5%,#ffffff);
...
.km-ios .km-detail {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.5),rgba(255,255,255,0.2) 50%,rgba(255,255,255,0.1) 50%,rgba(255,255,255,0));
...
.km-ios .km-filter-form {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.6),rgba(255,255,255,0.3));
...
.km-ios .km-content .km-buttongroup .km-button {
  ...
  background-image: -blink-linear-gradient(top,rgba(0,0,0,0),rgba(0,0,0,0.12) 50%,rgba(0,0,0,0.25));
...
.km-ios .km-content .km-buttongroup .km-state-active {
  ...
  background-image: -blink-linear-gradient(top,rgba(0,0,0,0.3),rgba(0,0,0,0) 50%,rgba(255,255,255,0.05) 50%,rgba(255,255,255,0.25));
...
.km-ios .km-toolbar {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.65),rgba(255,255,255,0));
...
.km-ios .km-tabstrip {
  ...
  background-image: -blink-linear-gradient(top,rgba(46,46,46,0.8),rgba(21,21,21,0.5) 50%,rgba(0,0,0,0.8) 50%,rgba(0,0,0,0.8));
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.18),rgba(255,255,255,0));
...
html .km-ios .km-tabstrip .km-button:active:last-child {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0),rgba(255,255,255,0.18)),-blink-linear-gradient(left,rgba(0,0,0,0.6),rgba(0,0,0,0) 3%,rgba(0,0,0,0) 97%,rgba(0,0,0,0.6));
...
.km-ios li.km-state-active .km-listview-label {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.28),rgba(255,255,255,0.1) 50%,rgba(255,255,255,0));
...
.km-ios .km-group-title {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0),rgba(255,255,255,0.3));
...
.km-ios .km-button.km-state-active .km-icon {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.7),rgba(255,255,255,0.9));
...
.km-ios .km-buttongroup .km-icon {
  ...
  background-image: -blink-linear-gradient(top,rgba(0,0,0,0.5),rgba(0,0,0,0.3));
...
.km-ios .km-tabstrip .km-icon {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.4),rgba(255,255,255,0));
...
.km-ios .km-tabstrip .km-state-active .km-icon {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.6) 0,rgba(255,255,255,0) 50%,rgba(255,255,255,0.3) 100%);
...
.km-ios .k-slider .k-draghandle:hover {
  ...
  background-image: -blink-linear-gradient(top,#cccccc,#ffffff);
...
.km-ios .k-slider-selection {
  ...
  background-image: -blink-linear-gradient(top,rgba(0,0,0,0.5),rgba(0,0,0,0) 15%,rgba(0,0,0,0) 90%,rgba(0,0,0,0.4)),-blink-linear-gradient(top,#2a5db2,#6da9f7);
...
.km-ios .k-slider-track {
  ...
  background-image: -blink-linear-gradient(top,rgba(0,0,0,0.3),rgba(0,0,0,0) 30%,rgba(0,0,0,0) 90%,rgba(0,0,0,0.4)),-blink-linear-gradient(top,#dbdbdb,#ffffff);
...
.km-ios .km-dialog-title {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.3),rgba(255,255,255,0) 60%);
...
.km-ios .km-actionsheet > li > a {
  ...
  background-image: -blink-linear-gradient(top,rgba(0,0,0,0),rgba(0,0,0,0.2) 50%,rgba(0,0,0,0.25) 85%,rgba(0,0,0,0.15));
...
.km-ios li.km-actionsheet-cancel > a {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.45),rgba(255,255,255,0.1) 60%,rgba(255,255,255,0) 80%,rgba(255,255,255,0.15));
...
.km-ios li.km-actionsheet-cancel > a {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.3),rgba(255,255,255,0) 60%,rgba(255,255,255,0) 85%,rgba(255,255,255,0.08));
...
.km-ios .km-popup .k-list-container {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.5),rgba(255,255,255,0.2) 10%,rgba(255,255,255,0));
...
.km-tablet .km-ios *:not(.km-tabstrip):not(.km-buttongroup) > .km-button {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.5),rgba(255,255,255,0));
...
.km-tablet .km-ios .km-modalview .km-header {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.9),rgba(255,255,255,0));
...
.km-ios7 .k-slider-selection {
  ...
  background-image: -blink-linear-gradient(top,#ffffff,#ffffff);
...
.km-android .km-rowdelete {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.5),rgba(204,204,204,0.5) 50%,rgba(255,255,255,0.1) 50%,rgba(255,255,255,0));
...
.km-android-light .km-rowdelete {
  ...
  background-image: -blink-linear-gradient(top,rgba(34,34,34,0.5),rgba(204,204,204,0.5) 50%,rgba(34,34,34,0.1) 50%,rgba(34,34,34,0));
...
.km-android .km-item label:before {
  ...
  background-image: -blink-linear-gradient(top,#363636,#2b2b2b);
...
.km-android-light .km-item label:before {
  ...
  background-image: -blink-linear-gradient(top,#c6c6c6,#d1d1d1);
...
.km-android-light .km-modalview .km-view-title {
  box-shadow: inset 0 -2px rgba(34, 34, 34, 0.1);
  -webkit-box-shadow: inset 0 -2px rgba(34, 34, 34, 0.1);
}
/* Tablet Styles */
...
html .km-android .km-toolbar .km-state-active {
  background: currentcolor;
  opacity: .6;
}
/* TabStrip */
...
.km-blackberry .km-scroller-refresh .km-loading-left {
  ...
  -moz-animation: km-blackberryload2 2.5s infinite linear;
...
.km-blackberry input[type=file] {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.7),rgba(255,255,255,0) 70%);
...
.km-blackberry .km-buttongroup {
  ...
  background-image: -blink-linear-gradient(top,rgba(0,0,0,0),rgba(0,0,0,0.1));
...
.km-blackberry .km-navbar .km-button {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.2),rgba(255,255,255,0));
...
.km-blackberry .km-popup.km-pane .km-header {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.2) 40%,rgba(255,255,255,0)),-blink-linear-gradient(left,rgba(255,255,255,0) 0,rgba(255,255,255,0.3));
...
.km-blackberry .km-switch-handle {
  ...
  background-image: -blink-linear-gradient(top,rgba(0,0,0,0),rgba(0,0,0,0.15));
...
.km-blackberry .k-slider .k-draghandle:hover {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.6),rgba(255,255,255,0));
...
.km-blackberry .km-popup .k-state-selected {
  ...
  background-image: -blink-linear-gradient(top,rgba(0,0,0,0),rgba(0,0,0,0.2));
...
.km-blackberry .k-dropdown.k-state-border-up {
  ...
  background-image: -blink-linear-gradient(top,#777777,#777777 10%,transparent 10%),-blink-linear-gradient(top,#777777,#777777 10%,transparent 10%),-blink-linear-gradient(top,#ffffff,#ffffff 10%,transparent 10%);
...
.km-blackberry .k-dropdown.k-state-border-down {
  ...
  background-image: -blink-linear-gradient(top,transparent 90%,#777777 90%,#777777),-blink-linear-gradient(top,transparent 90%,#777777 90%,#777777),-blink-linear-gradient(top,transparent 90%,#ffffff 90%,#ffffff);
...
.km-root .km-blackberry.km-pane .km-listview-label input[type=radio]:checked:after {
  ...
  background-image: -blink-linear-gradient(top,#ffffff,#f9f9f9 10%,#eeeeee);
...
.km-blackberry .km-popup.km-pane .km-content {
  ...
  background-image: -blink-linear-gradient(top,rgba(0,0,0,0.2),rgba(0,0,0,0) 10%);
...
.km-tablet .km-blackberry *:not(.km-actionsheet-phone) > .km-actionsheet > li:not(.km-actionsheet-cancel) > a:active {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.3),rgba(255,255,255,0));
...
.km-wp .km-content:not(.km-stretched-view) {
  display: block;
}
/* Color Template */
/* Variables */
...
.km-flat .k-slider-selection {
  ...
  background-image: -blink-linear-gradient(top,#bababa,#bababa);
