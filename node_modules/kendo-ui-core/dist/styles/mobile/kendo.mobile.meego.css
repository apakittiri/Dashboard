...
.km-meego .km-button {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0),rgba(255,255,255,0.1));
...
.km-meego .km-switch-container {
  ...
  background-image: -blink-linear-gradient(top,rgba(0,0,0,0),rgba(0,0,0,0) 98%,rgba(0,0,0,0.2));
...
.km-meego .km-switch-on .km-switch-wrapper {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0.2),rgba(255,255,255,0.3) 10%,rgba(255,255,255,0));
...
.km-meego .km-buttongroup li.km-state-active {
  ...
  background-image: -blink-linear-gradient(top,rgba(255,255,255,0),rgba(255,255,255,0.2));
...
.km-meego .k-slider-selection {
  ...
  background-image: -webkit-gradient(linear, 50% 0, 50% 100%, color-stop(0,#6da9f7), color-stop(1,#2a5db2));
  background-image: -blink-linear-gradient(top,#6da9f7,#2a5db2);
  background-image: -moz-linear-gradient(top,#6da9f7,#2a5db2);
  background-image: -ms-linear-gradient(top,#6da9f7,#2a5db2);
  background-image: -o-linear-gradient(top,#6da9f7,#2a5db2);
}
